(function capitalDataBootstrap(global) {
  ...
  // commercial inventory; current floors, divisibility and terms are confirmed
  // directly by the leasing team.
  ...
  const resources = Object.freeze([
    ...
    { id: 'availability', title: 'Reference Floor Plates', access: 'public', href: 'availability.html#current-opportunities', description: 'Published planning references with availability confirmed directly by leasing.' },
  ...
  global.CapitalData = Object.freeze({
    ...
    availabilityNotice: 'Public reference floor plates only. Current availability, areas, divisibility and commercial terms must be confirmed by the Capital Place leasing team.'
  });
})(window);
